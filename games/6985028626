...
Main:AddButton('Roblox Classic Cap', function()
	for i, v in pairs(workspace.DevModules.ScavengerHunt:GetChildren()) do
		v['Meshes/Token_Token_Base'].CFrame = player.Character.HumanoidRootPart.CFrame
	end
end)
